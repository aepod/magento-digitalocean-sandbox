#!/bin/bash
echo "Starting scripts/jmeter/initial_setup.sh"
...
if [[ ! -f ".vagrantlocks/jmeter" ]]; then
	...
	cp /root/magento-performance-toolkit-master/1.9ce/benchmark* /usr/local/apache-jmeter-2.13/tests/
...
echo "Finished scripts/jmeter/initial_setup.sh"